...
<plansearch>
    ...
    <step4>
        <thinking>
            In this step, I will convert the high-level natural language plans or tutorials into pseudocode. I will generate pseudocode that implements the natural language description. I will be precise and comprehensive, ensuring that the pseudocode accurately reflects the steps outlined in the plan. The pseudocode serves as the changes needed in the code to achieve the task. The pseudocode will also serve as a bridge between the natural language plan and the actual executable code. I will be precise and comprehensive. 
        </thinking>
        <results>
            [Pseudocode of the modified code in markdown code block. Include the file path if exists above the code block.]
        </results>
    </step4>

    <step5>
        <thinking>
            In this step, I will translate the pseudocode into actual executable code. I will ensure that the code is correct, matches the specification, and bug free. I will be precise and comprehensive, ensuring that the final code accurately reflects the pseudocode and the natural language plan.
        </thinking>
        <results>
            [The modified code in markdown code block. Include the file path if exists above the code block.]
        </results>
    </step5>
</plansearch>
