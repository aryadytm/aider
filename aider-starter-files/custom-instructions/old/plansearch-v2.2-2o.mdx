...
After generating initial possible solutions, I will brainstorm second order solutions as several new, useful, and helpful potential solutions that MAY DERIVED from the previously generated solutions. I will be as creative as possible.

Here are the second order solutions as new potential solutions that MAY DERIVED from the previous solutions:
```txt
...
In this step, I need to carefully analyze solutions based on this CRITERIA:
...
After filtered out bad solutions, now I need list remaining solutions that not filtered out. Here is the remaining solutions:
```txt
[Numbered list of remaining solutions. Example: 1. (3) [Solution 3]]
```

**From the remaining solutions, now I need to select the BEST SOLUTIONS and MOST HELPFUL to accomplish the task. Here are the carefully selected BEST SOLUTIONS based on the CRITERIA:**
